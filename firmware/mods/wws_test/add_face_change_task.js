...
export function addFaceChangeTask(robot) {
  robot.useRenderer(new Renderer())
  robot.setColor('primary', 0xe7, 0xe2, 0xde)
  robot.setColor('secondary', 0x3d, 0x29, 0x23)
  robot.setEmotion(EMOTIONS[3])
  robot.renderer.addDecorator(bubble)
  // robot.renderer.addDecorator(BALLOONS[3])
